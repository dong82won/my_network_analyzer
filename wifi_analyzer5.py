...
class NetworkDataCollector(QThread):
    ...
    def __init__(self, target_host="192.168.0.1", interface="wlan0"):
        super().__init__()
    ...
    def run(self):
        while self.is_running:
            metrics = NetworkMetrics(interface=self.interface, target_host=self.target_host)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.collector = NetworkDataCollector(target_host="192.168.0.1")
